...
void Builders::createSimpleBullet(ECS::World& world, Engine::Game& game, Components::Gun& gun, Components::Point& point, CollideLayers& ignoreLayers) {
	Size tileSize{ 9, 15 };
...
void Builders::createSimpleBullet(ECS::World& world, Components::Gun& gun, Components::Point& point, CollideLayers& ignoreLayers) {
